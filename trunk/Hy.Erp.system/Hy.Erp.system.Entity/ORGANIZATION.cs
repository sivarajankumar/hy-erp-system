...
namespace  Hy.Erp.system.Entity
{
	...
	/// 组织 
	/// </summary>
	[Serializable, Table(TableName = "ORGANIZATION")]
	public class ORGANIZATION : MapperEntity
		{
		private  int _iD = 0;
		private  string _nAME = string.Empty;
		private  string _aLIAS = string.Empty;
		private  string _rEGIONAL = string.Empty;
		private  string _nATUEE = string.Empty;
        ...
        /// 区域
        /// </summary>
		[Colum(ColumName = "REGIONAL", DbTypeAttr =DbType.String)]
        ...
        /// 性质
        /// </summary>
		[Colum(ColumName = "NATUEE", DbTypeAttr =DbType.String)]
		public string NATUEE
		{
			get { return _nATUEE; }
